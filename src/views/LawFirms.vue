                            ...
                            <div class="side-rgt-cards">
                                <div class="side-rgt-card">
                                    ...
                                    <div class="profile-access">
                                        <button class="btn-p-success-tp" @click="showDrawer"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" width="16" class="inline-flex mr-2
